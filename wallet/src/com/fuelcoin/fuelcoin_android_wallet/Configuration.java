...
public class Configuration
{
	...
	public ExchangeRatesProvider.WalletExchangeRate getCachedExchangeRate()
	{
				...
				&& prefs.contains(PREFS_KEY_CACHED_EXCHANGE_RATE_FIAT))
		{
			...
			return new ExchangeRatesProvider.WalletExchangeRate(new ExchangeRate(cachedExchangeRateCoin, cachedExchangeRateFiat), null);
		}
		else
		{
			return null;
	...
	public void setCachedExchangeRate(final ExchangeRatesProvider.WalletExchangeRate cachedExchangeRate)
	{
