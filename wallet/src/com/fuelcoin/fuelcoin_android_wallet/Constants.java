...
package com.fuelcoin.fuelcoin_android_wallet;
...
public final class Constants
{
	...
	public final static class Files
	{
		...
		public static final String WALLET_FILENAME_PROTOBUF = "fuelcoinj-wallet-protobuf";

		/** Filename of the automatic key backup (old format, can only be read). */
		public static final String WALLET_KEY_BACKUP_BASE58 = "fuelcoinj-key-backup-base58";

		/** Filename of the automatic wallet backup. */
		public static final String WALLET_KEY_BACKUP_PROTOBUF = "fuelcoinj-key-backup-protobuf";

		/** Manual backups go here. */
		public static final File EXTERNAL_WALLET_BACKUP_DIR = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS);

		/** Filename of the manual key backup (old format, can only be read). */
		public static final String EXTERNAL_WALLET_KEY_BACKUP = "fuelcoinj-wallet-keys";

		/** Filename of the manual wallet backup. */
		public static final String EXTERNAL_WALLET_BACKUP = "fuelcoinj-wallet-backup";
	...
	public static final String MIMETYPE_WALLET_BACKUP = "application/x-fuelcoinj-wallet-backup";
