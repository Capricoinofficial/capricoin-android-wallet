...
package com.capricoin.capricoin_android_wallet.ui.preference;
...
public final class AboutFragment extends PreferenceFragment
{
	...
	private static final String KEY_ABOUT_CREDITS_PEERCOINJ = "about_credits_capricoin";
	...
	public void onCreate(final Bundle savedInstanceState)
	{
		...
		findPreference(KEY_ABOUT_CREDITS_PEERCOINJ).setTitle(getString(R.string.about_credits_capricoinjj_title, VersionMessage.CAPRICOINJ_VERSION));
	}
}
