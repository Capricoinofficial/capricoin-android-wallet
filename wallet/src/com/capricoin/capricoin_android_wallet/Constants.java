...
public final class Constants
{
	...
	public final static class Files
	{
		...
		public static final String WALLET_FILENAME_PROTOBUF = "capricoinj-wallet-protobuf";

		/** Filename of the automatic key backup (old format, can only be read). */
		public static final String WALLET_KEY_BACKUP_BASE58 = "capricoinj-key-backup-base58";

		/** Filename of the automatic wallet backup. */
		public static final String WALLET_KEY_BACKUP_PROTOBUF = "capricoinj-key-backup-protobuf";

		/** Manual backups go here. */
		public static final File EXTERNAL_WALLET_BACKUP_DIR = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS);

		/** Filename of the manual key backup (old format, can only be read). */
		public static final String EXTERNAL_WALLET_KEY_BACKUP = "capricoinj-wallet-keys";

		/** Filename of the manual wallet backup. */
		public static final String EXTERNAL_WALLET_BACKUP = "capricoinj-wallet-backup";
	...
	public static final String EXPLORE_BASE_URL = "https://chainz.cryptoid.info/cpc/";
	...
	public static final String MIMETYPE_WALLET_BACKUP = "application/x-capricoinj-wallet-backup";
	...
	public static final String SOURCE_URL = "https://github.com/kris-davison/capricoin-android-wallet";
	public static final String BINARY_URL = "https://github.com/kris-davison/capricoin-android-wallet/releases";
