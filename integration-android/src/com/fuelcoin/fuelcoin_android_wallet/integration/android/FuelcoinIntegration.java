...
package com.fuelcoin.fuelcoin_android_wallet.integration.android;
 ...
 */
public final class FuelcoinIntegration
{
	...
	private static final String MIMETYPE_PAYMENTREQUEST = "application/fuelcoinj-paymentrequest"; // BIP 71
	...
	private static void redirectToDownload(final Context context)
	{
		...
		final Intent marketIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.fuelcoin.fuelcoin"));
		final Intent binaryIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/MatthewLM/fuelcoinj-android-wallet"));
