...
package com.capricoin.capricoin_android_wallet.integration.android;
 ...
 */
public final class CapricoinIntegration
{
	...
	private static final String MIMETYPE_PAYMENTREQUEST = "application/capricoinj-paymentrequest"; // BIP 71
	...
	{
		final Intent intent = makeFuelcoinUriIntent(address, null);
	...
	{
		final Intent intent = makeFuelcoinUriIntent(address, amount);
	...
	{
		final StringBuilder uri = new StringBuilder("capricoin:");
		if (address != null)
			uri.append(address);
		if (amount != null)
	...
	private static void redirectToDownload(final Context context)
	{
		...
		final Intent marketIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.capricoin.capricoin"));
		final Intent binaryIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/MatthewLM/capricoinj-android-wallet"));
